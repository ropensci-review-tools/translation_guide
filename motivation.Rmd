...
rOpenSci is carrying out a series of activities and projects to transform science to ensure that serves everyone in our communities, which includes our multilingual publishing project.

## Language barrier

English is the *lingua franca* for science creating a significant barrier for non-English speakers waiting to join the field. 
...
The community organizes and agrees on different aspects of the localization project[^motivation-6].
...
These projects and previous community experiences created the conditions for us to start multilingual publishing in Spanish. 
