...
Once you've [contacted the project manager](#contributing) and you're ready to start contributing, 
...
1. **Check out the *branch* associated with the file you are going to review.**
    For example, if you are reviewing `softwarereview_policies.en.Rmd`, the branch would be `softwarereview_policies.es.Rmd-en`.
...
6.  **Notify the project manager or the second reviewer.**
...
- Apply style decisions missed by R1.
...
In the process of performing the second review you may need to consult with R1 about the decisions they made or with the rest of the community if there is a phrase or term that raises doubts.
...
1. **Checkout the *branch*** associated to the file you are going to check.**
    ...
    you would look for the `softwarereview_policies.es.Rmd-en` branch.

2.  **Pull the changes.** 
    Do a *pull* to download all the changes R1 made to update your local copy.**
...
1. **Check your repository and branch**. 
  Make sure that all changes are in the working repository and that you are working on the *branch* associated to the file under review, for example `softwarereview_policies.es.Rmd-en`.
