...
You can check the [list of languages for which there are active translation projects](https://github.com/ropensci-review-tools/translation_guide#active) and their statuses in the readme of the repository of this book.
...
The source code that generates the "rOpenSci Packages: Development, Maintenance, and Peer Review" lives at [github.com/ropensci/dev_guide](https://github.com/ropensci/dev_guide), and is organized in .Rmd (RMarkdown) format files that contain text and sometimes also code.
