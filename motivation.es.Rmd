...
rOpenSci está llevando a cabo una serie de actividades y proyectos para transformar la ciencia y garantizar que sirva a todas las personas que son parte de nuestra comunidad, entre los que se incluye nuestro proyecto de publicación multilingüe.
...
Además, el informe de la Fundación Linux afirma que "el dominio del inglés es una métrica con la que se puede juzgar el rendimiento y la personalidad"[^motivation-4].
...
Estos estudios también destacan que "la magnitud de la desventaja parece estar muy por encima del nivel que puede superarse con un esfuerzo individual"[^motivation-5].
...
Ciencia de Datos Multilingüe: Diez consejos para traducir contenido de ciencia y la tecnología
       Chapter at Our Environment.A collection of work by data
...
El español es la segunda lengua materna más hablada del mundo y una de las más extendidas geográficamente, siendo lengua oficial en muchos países[^motivation-7].

[^motivation-7]: Lista de lenguas por número de hablantes nativos.
