...
-   The *localization* is the process of taking a piece of content in its original form and converting it into something accessible and suitable for another region, country, or audience[^intro-2].
...
These technological solutions are continuously evolving. The choice of technology impacts the paths we create for contributions, so they should not be a barrier[^intro-5].
...
* [The babeldown package](https://docs.ropensci.org/babeldown/) allows for a first automatic translation of the documents.

* [The babelquarto package](https://docs.ropensci.org/babelquarto/) allows for configuring and generating a multilingual Quarto book or website.
...
All the next examples use the rOpenSci Packages: Development, Maintenance, and Peer Review book localization, but you can apply this recommendations to any of the other translations.
