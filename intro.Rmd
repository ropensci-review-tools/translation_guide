...
This provides a first draft that is then reviewed by a human, who corrects errors and incorporates the localization and [language-specific guidelines](specific_guidelines.html).
