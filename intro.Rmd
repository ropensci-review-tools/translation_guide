...
Internationalization and Localization[^intro-1]:
...
1.  Translating the material in the first place.

2.  Keeping the material updated and synchronized among the supported languages[^intro-3].
...
These technological solutions are continuously evolving. The choice of technology impacts the paths we create for contributions, so care should be taken to pick technology that reduces barriers to participation as much as possible[^intro-5].
...
4.  Try to be idiomatic.
    Don't worry about literal translations. Bring the message closer to your audience[^intro-6] by choosing 
...
[^intro-7]: Based on the APA article ["How to cite translated works"](https://apastyle.apa.org/blog/citing-translated-works).
