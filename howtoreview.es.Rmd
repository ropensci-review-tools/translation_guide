...
Puedes revisar la lista de idiomas para los que hay proyectos de traducción activos y sus estados [aquí](https://github.com/ropensci-review-tools/translation_guide##languages-with-active-projects).
Allí encontrarás el nombre de quienes que quien mantiene cada proyecto para que puedas ponerte en contacto y links a los proyectos activos en ese idioma.
Las iniciativas de traducción cuentan con un canal en el Slack de rOpenSci por idioma donde se discute y se toman decisiones sobre la traducción, las cuales son plasmadas en las directrices específicas del idioma ([aquí](specific_guidelines.html)) en esta guía y un glosario ([aquí](glosario-es)).

Antes de comenzar es importante que te familiarices con el material original.
Además, te sugerimos leer esta guía (en particular las directrices aplicables a tu idioma ([aquí](specific_guidelines.html)) y contactarte con las personas que ya se encuentran trabajando.
...
Pedimos a quienes gestionan proyectos de traducción el mismo compromiso que pedimos a quienes gestionan paquetes de nuestra suite: 1 año de mantenimiento luego de finalizada la traducción o poder encontrar a otra persona que se haga cargo.
...
El código fuente que genera la Guía de desarrollo vive en [github.com/ropensci/dev_guide](https://github.com/ropensci/dev_guide), y está organizada en archivos con formato .Rmd (RMarkdown) que contienen texto y a veces también código de R.
...
El proceso de revisión es un proceso colaborativo en el que, esperamos, colaboren muchas personas.
